...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ticket-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETASSIGNMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TICKETASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TICKETASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TICKETASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TICKETASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TICKETASSIGNMENT actions', async () => {
      const expectedActions = [
        {
