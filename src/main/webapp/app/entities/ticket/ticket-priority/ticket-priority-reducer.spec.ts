...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETPRIORITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TICKETPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TICKETPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TICKETPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TICKETPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TICKETPRIORITY actions', async () => {
      const expectedActions = [
        {
