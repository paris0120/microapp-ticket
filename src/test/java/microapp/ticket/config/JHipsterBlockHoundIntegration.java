...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("microapp.ticket.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("microapp.ticket.security.DomainUserDetailsService", "createSpringSecurityUser");
