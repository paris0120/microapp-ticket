...
class TicketKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/ticket-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
